...
Adresat::Adresat (int i,int iU, string im, string naz, string nrTel, string em, string adr){
    id = i;
    idUzytkownika = iU;
    imie = im;
    nazwisko = naz;
...
void Adresat::wprowadzanieNowychOsobDoKsiazki (vector <Adresat> &ksiazkaAdresowa, int idUzytkownika){
    Adresat osobaZKsiazkiAdresowej(0,0,"","","","","");
    int i=0;
    system ("cls");
...
string Adresat::zamienWielkoscLiter (string tekstDoZamiany){
...
int Adresat::okreslID (vector <Adresat> &ksiazkaAdresowa, int idUzytkownika){
    int id = 0;
    ksiazkaAdresowa.clear();
...
void Adresat::zapiszOsobyDoPliku (Adresat osobaZKsiazkiAdresowej, vector <Adresat> &ksiazkaAdresowa){
    fstream plik;
...
void Adresat::wyszukiwaniePoImieniu (vector <Adresat> &ksiazkaAdresowa){
...
void Adresat::wyszukiwaniePoNazwisku(vector <Adresat> &ksiazkaAdresowa){
...
void Adresat::pokazWszystkich (vector <Adresat> &ksiazkaAdresowa){
    system("cls");
    if (!ksiazkaAdresowa.empty())
    {
        for (vector <Adresat> :: iterator itr = ksiazkaAdresowa.begin(); itr != ksiazkaAdresowa.end(); itr++)
...
void Adresat::usuwanieRekorduZPliku (vector <Adresat> &ksiazkaAdresowa, int idUzytkownika){
...
void Adresat::zapiszOsobyDoPlikuNadpisujacPlik (vector <Adresat> &ksiazkaAdresowa, int idUzytkownika){
